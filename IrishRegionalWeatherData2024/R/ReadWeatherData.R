...
saveRDS(East_Region_Weather,"data/East_Region_Weather.rdata")

West_Region_Weather<-prepare_2("data_raw/MaceHead.csv","West",)
saveRDS(West_Region_Weather,"data/West_Region_Weather.rdata")

Central_Region_Weather<-prepare_2("data_raw/Mullingar.csv","Central")
saveRDS(Central_Region_Weather,"data/Central_Region_Weather.rdata")

South_Region_Weather<-prepare_2("data_raw/Valentia.csv","South",23)
saveRDS(South_Region_Weather,"data/South_Region_Weather.rdata")

North_Region_Weather<-prepare_2("data_raw/MalinHead.csv","North",23)
saveRDS(North_Region_Weather,"data/North_Region_Weather.rdata")
