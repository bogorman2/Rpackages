...
library(readxl)
qtr_hourly_2024.df<-read_excel("System_Data_Qtr_Hourly_2024.xlsx")
#qtr_hourly_2025.df<-read_excel("System-Data-Qtr-Hourly-2025-v3.xlsx")
qtr_hourly_20142015.df<-read_excel("System-Data-Qtr-Hourly-2014-2015.xlsx")
qtr_hourly_20162017.df<-read_excel("System-Data-Qtr-Hourly-2016-2017.xlsx")
qtr_hourly_20182019.df<-read_excel("System-Data-Qtr-Hourly-2018-2019.xlsx")
qtr_hourly_20202021.df<-read_excel("System-Data-Qtr-Hourly-2020-2021.xlsx")
qtr_hourly_20222023.df<-read_excel("System-Data-Qtr-Hourly-2022-2023.xlsx")
...
#qtr_hourly_WG_2025.df<-data.frame(qtr_hourly_2025.df["DateTime"],qtr_hourly_2025.df["IE Wind Generation"])
...
#wind_generation_data<-rbind(wind_generation_data,averageHourlyData(qtr_hourly_WG_2025.df)) # as above for given part of 2025

saveRDS(wind_generation_data,"WindPower2024.rdata") #saves the data to the ~/data to be available to package users
